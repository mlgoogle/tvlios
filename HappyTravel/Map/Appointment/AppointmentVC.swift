...
class AppointmentVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, DateSelectorSheetDelegate , CitysSelectorSheetDelegate, SkillsCellDelegate, SkillTreeVCDelegate {
    ...
    func initView() {
        ...
        commitBtn.addTarget(self, action: #selector(AppointmentVC.appointmentReply), for: .touchUpInside)
    ...
    func appointment() {
        ...
        let dict:[String: AnyObject] = ["uid_": DataManager.currentUser!.uid as AnyObject,
                                        ...
                                        "is_other_": (agent ? 0 : 1) as AnyObject,
                                        "other_name_": ((agent ? name! : "") as AnyObject) ,
                                        "other_gender_": (agent  ? (gender == true ? 1 : 0) : 0) as AnyObject,
                                        "other_phone_": (agent ? tel! : "") as AnyObject]
